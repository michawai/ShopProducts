sap.ui.define([
...
], function(BaseController, Sorter, messages, MessageToast, JSONModel, formatter, formatterReuse, Device, TabContainer, TabContainerItem,
	Fragment, Filter) {
	...
	return BaseController.extend("nw.epm.refapps.shop.controller.S3_MultiProductDetails", {
		...
		_onRouteMultiProductsMatched: function(oEvent) {
		...
		onTabContainerItemSelect: function(oEvent) {
			//Reset PruductId
			this._sProductId = "";
		},

		onTabContainerItemClose: function(oEvent) {
		...
		onToggleFavoritePressed: function(oEvent) {
		...
		_onTabContainerDataReceived: function(oEvent) {
